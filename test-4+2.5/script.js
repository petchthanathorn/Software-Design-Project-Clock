...
function resetTimer() {
    ...
    setTimeByMode();
    updateDisplay();
    resetRoundSymbols(); // เรียกใช้ resetRoundSymbols เมื่อครบ 4/4 รอบ
    // pomodoroRounds = 0; // รีเซ็ตจำนวนรอบ Pomodoro
}
...
// รีเซ็ตสัญลักษณ์รอบ Pomodoro
function resetRoundSymbols() {
    // ค้นหาและรีเซ็ตพื้นที่ที่แสดงสัญลักษณ์รอบ
    const roundSymbolsContainer = document.getElementById('pomodoro-rounds');
    
    // ลบสัญลักษณ์ทั้งหมดใน container
    roundSymbolsContainer.innerHTML = ''; 
}
